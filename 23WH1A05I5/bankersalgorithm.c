...
void bankersAlgorithm(int processes, int resources, int allocation[MAX_PROCESSES][MAX_RESOURCES], int max[MAX_PROCESSES][MAX_RESOURCES], int available[MAX_RESOURCES]){
